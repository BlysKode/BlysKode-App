...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed right-5 bottom-5 z-[60] flex min-h-14 min-w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_8px_30px_-4px_rgba(37,211,102,0.5)] transition-transform hover:scale-110 md:right-8 md:bottom-8"
    >
